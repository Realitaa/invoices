            ...
            @foreach ($products as $product)
                ...
                @foreach ($product->subproducts as $subproduct)
                    <tr class="font-normal">
                        ...
                        <td class="w-20 text-end">{{ $subproduct->subproduct_sid }}</td>
                        <td class="w-20 text-end">{{ $subproduct->subproduct_bw }}</td>
                        <td class="w-20 text-end">{{ $subproduct->subproduct_period }}</td>
                        <td class="w-20 text-end">{{ number_format($subproduct->subproduct_amount, 0, ',', '.') }}</td>
                    </tr>
                @endforeach
                <tr>
